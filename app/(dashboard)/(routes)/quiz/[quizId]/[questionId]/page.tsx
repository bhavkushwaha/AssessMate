    ...
    <div className="flex flex-col h-screen gap-8">
      <div className="px-6 lg:px-12 flex items-center justify-between">
        <div className="flex items-center gap-6">
          <Link href="/quiz" className="text-5xl">
            <ChevronLeft size={44} />
          </Link>
          <h1 className="text-5xl font-semibold">{quizData.topic}</h1>
        </div>
        <QuizProgress
          ...
          {result === 0 ? (
            ...
            <div className="flex items-center justify-between w-full">
              <div>
                ...
                {result === -1 && (
                  <h1 className="uppercase text-red-600 text-sm">
              ...
              <button
                ...
                className="disabled:cursor-not-allowed border-[3px] font-semibold text-emerald-600 text-2xl border-emerald-500 hover:text-white transition-colors duration-150 hover:bg-emerald-500 w-fit px-3 py-2 rounded-xl"
              >
